                        ...
                        <div id="" class="hidden mt-2 dropdownContent">
                            <div class="overflow-x-auto">
                                ...
                                <div class="grid grid-cols-2 gap-4 mt-4 text-sm text-gray-700">
                                    ...
                                    <div><strong>Business Reg. No:</strong> <span id="business_reg_no">1234567890</span>
                                    </div>
        ...
        function approveKyc(sellerId, step) {
            ...
            if (reason) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: 'Cannot approve with a rejection reason entered. Please clear the reason field.',
