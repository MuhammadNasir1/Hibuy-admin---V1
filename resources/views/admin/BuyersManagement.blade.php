...
@section('content')
    <div class="w-full pt-10 min-h-[86vh]   rounded-lg custom-shadow">
        <div class="flex justify-between px-5">
            <h2 class="text-3xl font-bold ">Buyers List</h1>
        </div>
        @php
            $headers = [
                'Sr.',
                ...
                <tr>
                    ...
                    <td>
                        <span class='flex gap-4'>
                            ...
                            <button class="viewmanagebuyersBtn" id="addmanagebuyersBtn" data-modal-target="managebuyers-modal" data-modal-toggle="managebuyers-modal">
