...
@section('content')
    <div class="w-full pt-10 min-h-[86vh]   rounded-lg custom-shadow">
        <div class="flex justify-between px-5">
            <h2 class="text-2xl font-medium ">Freelancers List</h1>
        </div>
        @php
            $headers = [
                'Sr.',
                ...
                <tr>
                    ...
                    <td>
                        <span class='flex gap-4'>
                            ...
                            <button id="addmanagefreelancerBtn" data-modal-target="managefreelancer-modal" data-modal-toggle="managefreelancer-modal" class="viewModalBtn">
        ...
        <x-modal id="managefreelancer-modal">
