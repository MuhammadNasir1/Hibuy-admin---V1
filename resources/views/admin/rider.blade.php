    ...
    <div class="px-5 w-full pt-10 min-h-[86vh]   rounded-lg custom-shadow">
        <div class="flex justify-between px-5">
            <h2 class="text-2xl font-medium ">Rider List</h1>
                @if (session('user_details.user_role') == 'admin' || canMenuAction('rider', 'add'))
                            ...
                            <td>
                                <span class="flex gap-2">
                                    ...
                                    <form id="delete-form-{{ $data->id }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        @if (session('user_details.user_role') == 'admin' || canMenuAction('rider', 'delete'))
                                    ...
                                    {{-- Edit Button --}}
                                    @if (session('user_details.user_role') == 'admin' || canMenuAction('rider', 'edit'))
