            ...
            <div class="h-[150px] border rounded-xl mx-6 mt-3 flex justify-center items-center">
                <div class="h-[80%] w-[95%] rounded-xl flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-5">
                        <img src="{{ asset($storeData['profile_picture'] ?? 'asset/pic.jpg') }}"
                            class="h-[80px] w-[80px] rounded-full" alt="">
                        <div>
                            <h3 class="text-lg font-semibold">{{ $storeData['user']->user_name }} </h3>
                            {{-- <p class="text-sm text-gray-500 flex gap-3 items-center pt-1">
                                +92 300 1234567
                            </p> --}}
                            <p class="text-sm text-gray-500 flex gap-3 items-center pt-1">
                                {{ $storeData['user']->user_email }}
                            </p>
                        </div>
                    </div>
        ...
        <div class="mt-5">
            ...
            <div
                ...
                <div class="h-[80%] w-[95%] bg-white rounded-xl flex items-center justify-between px-5">
                    <div class="flex items-center gap-5">
                        <img src="{{ asset($storeData['profile_picture_store'] ?? 'asset/pic.jpg') }}
" class="h-[80px] w-[80px] rounded-full" alt="">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 flex gap-3 items-center pt-1">
                                ...
                                </span>{{ $storeData['product_count'] }} Product Listed
                            </p>
                        </div>
                    </div>
