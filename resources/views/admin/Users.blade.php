...
@section('content')
    <div class="w-full pt-10 min-h-[86vh] rounded-lg custom-shadow">
        <div class="flex justify-between items-center px-5">
            ...
            <div>
                @if (session('user_details.user_role') == 'admin' || canMenuAction('add-users', 'add'))
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="flex gap-4">
                                <!-- Delete Button -->
                                @if (session('user_details.user_role') == 'admin' || canMenuAction('add-users', 'delete'))
                                ...
                                @endif
                                @if (session('user_details.user_role') == 'admin' || canMenuAction('add-users', 'edit'))
                                    <!-- Edit Button -->
