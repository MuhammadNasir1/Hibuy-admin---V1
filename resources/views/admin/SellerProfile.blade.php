...
@section('content')
    <div class="w-full pt-10 pb-10 min-h-[86vh]   rounded-lg custom-shadow">
        ...
        <div class="mt-5 mx-6 shadow-xl rounded-xl min-h-[100px]">
            ...
            <img src="{{ $storeBanner }}" alt="Banner Image" class="w-full object-cover rounded-xl">
        ...
        <div class="flex justify-center px-6 gap-5 ">
            @foreach ($storeData['store_posts'] as $post)
                @php
                    ...
                    $defaultPostImage = asset('asset/post-1.png');
                ...
                <div class="lg:h-[370px] h-[200px] lg:w-[370px] w-[200px] rounded-xl mt-5 shadow-xl"
                    style="background-image: url('{{ $postImage }}'); background-size: cover; background-position: center;">
                </div>
            @endforeach
        </div>
