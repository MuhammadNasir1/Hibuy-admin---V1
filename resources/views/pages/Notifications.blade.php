        ...
        <x-table :headers="$headers">
            <x-slot name="tablebody">
                ...
                <tr>
                    ...
                    <td>Jan 2, 2024</td>
                    <td>
                        <span class="px-2 py-1 text-xs font-semibold text-white bg-green-500 rounded">Read</span>
                    </td>
                    <td>
                        <span class='flex gap-4'>
                            ...
                            <button data-modal-target="view-notification-modal" data-modal-toggle="view-notification-modal"
                                class="viewModalBtn">
                ...
                <form>
                    ...
                    <div class="md:py-5">
                        ...
                        <div class="flex gap-6 px-6 mt-5">
                            ...
                            <div class="w-1/2">
                                <label
                                    class="block mb-2 text-sm font-medium dark:text-white text-customBlack">Type</label>
                                    <p
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    {{ $type ?? 'Promotional' }}
                                </p>
                        ...
                        <div class="flex gap-6 px-6 mt-5">
                            <div class="w-1/2">
                                <label
                                    class="block mb-2 text-sm font-medium dark:text-white text-customBlack">Target Audience</label>
                                <p
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    {{ $t_audience ?? 'Seller' }}
                                </p>
