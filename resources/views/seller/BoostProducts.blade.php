...
@section('content')
    <div class="w-full pt-10 pb-10 min-h-[86vh]   rounded-lg custom-shadow">
        @if ($packageStatus == 'approved' && $packageDetail['package_end_date'] >= now())
                ...
                <div>
                    ...
                    <ul class="space-y-2 mt-3">
                        <li class="flex items-center gap-2 pb-2">
                            ...
                            <span>Boost your products to appear at the top of listings</span>
                        </li>
                        <li class="flex items-center gap-2 pb-2">
                            <svg width="23" height="25" viewBox="0 0 33 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span>Increase product visibility and reach more buyers</span>
                        </li>
                        <li class="flex items-center gap-2 pb-2">
                            <svg width="23" height="25" viewBox="0 0 33 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span>Get higher chances of sales with promoted products</span>
                        </li>
                        <li class="flex items-center gap-2 pb-2">
                            <svg width="23" height="25" viewBox="0 0 33 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span>Stand out from competitors in your category</span>
                        </li>
                        <li class="flex items-center gap-2 pb-2">
                            <svg width="23" height="25" viewBox="0 0 33 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span>Real-time performance insights on boosted items</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <table class="w-full mt-2 border-collapse">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="flex items-center gap-2 relative">
                                    <span class="text-primary px-2 py-1" id="accountNumber">
                                        1234567890
                                    </span>
                                    <button onclick="copyToClipboard(this)"
                                        class="bg-gray-200 px-2 py-1 text-sm rounded hover:bg-gray-300 relative">
                                        Copy
                                        <span
                                            class="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs rounded px-2 py-1 opacity-0 transition-opacity duration-300 pointer-events-none"
                                            id="tooltip">
                                            Copied!
                                        </span>
                                    </button>
...
@section('js')
    <script>
        function copyToClipboard(button) {
            const text = document.getElementById("accountNumber").innerText.trim();
